    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.right_bumper) {
                leftArm.setTargetPosition(-440);
                rightArm.setTargetPosition(-440);
            ...
            if ( gamepad2.dpad_right) {
                leftArm.setTargetPosition(-1895);
                rightArm.setTargetPosition(-1895);
            ...
            if ( gamepad2.dpad_left) {
                leftArm.setTargetPosition(-1618);
                rightArm.setTargetPosition(-1618);
